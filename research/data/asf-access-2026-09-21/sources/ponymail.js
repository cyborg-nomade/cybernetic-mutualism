...
window.addEventListener('load', function() {
    let powered_by = "Powered by Apache Pony Mail (Foal v/%s ~%s). For data privacy requests, please contact: privacy@apache.org. For questions about this service, please contact: users@infra.apache.org.".format(PONYMAIL_VERSION, PONYMAIL_REVISION);
...
function listview_threaded_element(thread, idx) {
    ...
    let link_wrapper = new HTML('a', {
        ...
        onauxclick: 'console.log("mbtn", this.href); return this.href;'
    });
